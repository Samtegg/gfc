        ...
        <div className='dashboard-rightbar'>
          ...
          <div className='dashboard-pay'>
            <div className='pay payout'>
              ...
              <div className='payout-content'>
                <div>
                  <p className='payout-name'>Cliton Sylvester</p>
                  <p className='payout-date'>Nov 24, 2020 | 09:26:08 AM</p>
                </div>
            ...
            <div className='pay received'>
              ...
              <div className='received-content'>
                <div>
                  <p className='received-name'>Cliton Sylvester</p>
                  <p className='received-date'>Nov 24, 2020 | 09:26:08 AM</p>
                </div>
          ...
          <div className='dashboard-level'>
            ...
            <div className='level-cards center-cards'>
                <Dashlevelcard level='1' money='1000' members='2'  />
